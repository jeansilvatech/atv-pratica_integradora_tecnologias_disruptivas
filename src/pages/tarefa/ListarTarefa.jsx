        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableRow className='table_title'>
                    ...
                    <TableCell className='table_cell'>Título</TableCell>
                    <TableCell className='table_cell' align="right">Descrição</TableCell>
                    <TableCell className='table_cell' align="right">Data de Início</TableCell>
                    <TableCell className='table_cell' align="right">Data de Finalização</TableCell>
                    <TableCell className='table_cell' align="right">Status</TableCell>
                    <TableCell className='table_cell' align="right">Recurso</TableCell>
                    <TableCell className='table_cell' align="left"></TableCell>
                    <TableCell className='table_cell' align="left"></TableCell>
                </TableRow>
                </TableHead>
                <TableBody>
